                ...
                <div className="w-full flex items-center justify-center">
                    ...
                    <div className="flex flex-col items-center lg:hidden">
                        <div className="mb-4 w-full max-w-sm relative">
                            <button
                                onClick={copyToClipboard}
                                className="bg-white/10 text-white px-3 py-3 rounded-md backdrop-blur-sm border border-white/20 flex items-center justify-center gap-2 flex-wrap hover:bg-white/20 transition-colors w-full"
                                title={contractAddress}
                            >
                                <span className="font-montserrat text-sm whitespace-nowrap">
                                    Token Contract
