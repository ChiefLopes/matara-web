...
function RoadMap() {
    return (
        ...
        >
            ...
            <motion.p
                className="font-montserrat font-[600] text-[32px] lg:text-[52px] text-white"
            ...
            <motion.p
                className="font-montserrat font-[400] text-[18px] lg:text-[20px] text-white text-center"
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="relative z-10 p-8 min-h-[180px]">
                                ...
                                <h3 className="text-white text-xl text-nowrap font-[700] mb-4">
                                    {card.title}
                                </h3>
                                <ul className="mt-2 space-y-4 text-gray-300">
                                    {card.items.map((it, i) => (
                                        ...
                                        >
                                            <span className="w-1.5 h-1.5 mt-2 rounded-full bg-secondary block flex-shrink-0"></span>
